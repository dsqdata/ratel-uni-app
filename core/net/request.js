...
class Request {
    ...
    config = {
        ...
        baseUrl: '',//接口请求基地址
        //method: 'GET',
        //contentType: 'json',//请求类型可选值为json、form、file、text、html
        business: 'content',//接口响应的业务数据对象字段名，默认为data，如果返回整个业务对象，则需要设置为undefined
        //dataType: 'json',
        //encoding: 'UTF-8',//请求编码，默认为utf-8
        // skipInterceptorResponse: false, //是否跳过响应过滤器，如需跳过，请置true
        // slashAbsoluteUrl: true, //是否视以/开头的url为绝对地址，默认为false，此设置仅当初步判断url为非绝对地址时有效
        // debug: false, //是否开启debug模式，在此模式下，所有的请求都会打印请求参数，响应对象或错误信息
        // loadingTip: undefined, //是否在请求前显示文字为参数值的loading提示，如果是，会在请求结束后自动关闭loading提示
        // loadingDuration: 500, //设置loadingTip时的最小loading显示时间
        // responseType: 'text'
    }
